...
public class FormHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(250, 20, 260, 40);

        jLabel2.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jLabel2.setText("Selamat Datang di BANK NEGARA INDONESIA");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(230, 60, 310, 30);
        ...
        saldo.setBounds(580, 250, 103, 32);
        ...
        penarikan.setBounds(80, 190, 103, 32);
        ...
        transfer.setBounds(250, 190, 103, 32);
        ...
        setor.setBounds(420, 190, 103, 32);
        ...
        logOut.setBounds(580, 310, 100, 30);
        getContentPane().add(inputPenarikan);
        inputPenarikan.setBounds(80, 230, 103, 30);
        getContentPane().add(inputTransfer);
        inputTransfer.setBounds(250, 230, 103, 30);
        getContentPane().add(inputSetor);
        inputSetor.setBounds(420, 230, 103, 30);

        keterangan.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        getContentPane().add(keterangan);
        keterangan.setBounds(130, 280, 320, 30);

        nilai.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        getContentPane().add(nilai);
        nilai.setBounds(210, 320, 210, 30);

        jLabel6.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jLabel6.setText("Isikan PENARIKAN, TRANSFER, dan SETOR");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(230, 90, 290, 30);

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "MENU", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 0, 18))); // NOI18N
        getContentPane().add(jPanel1);
        jPanel1.setBounds(30, 160, 540, 260);

        setBounds(0, 0, 745, 505);
